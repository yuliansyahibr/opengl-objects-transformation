...
{
public:
	Lemari2(glm::vec3 pos) : Object(pos) {}
	Lemari2(glm::vec3 pos, float init_degree) : Object(pos, init_degree) {}
...
private:
	float v_buffer[192] = {
		...
		-0.045f, -0.7f,  0.42f,		// [4] back bot left
		 0.045f, -0.7f,  0.30f,		// [5] back bot right
		-0.045f,  0.7f,  0.30f,		// [6] back top left
		 0.045f,  0.7f,  0.30f,		// [7] back top right
